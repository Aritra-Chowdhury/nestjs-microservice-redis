...
Allows customer to create , update , get , deactivate account details for a particular customer.
...
![Banking API Architecture diagram](/readme_images/Architecture-diagram-account.png)
